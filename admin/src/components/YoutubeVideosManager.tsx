...
import { BrandButton, Chip } from "./UIBits";
...
type SeccionOption = { key: string; label: string };
...
export function YoutubeVideosManager({ title, eyebrow, description, secciones }: { title: string; eyebrow: string; description: string; secciones: SeccionOption[] }) {
  ...
  const [seccion, setSeccion] = useState<string>(secciones[0].key);
